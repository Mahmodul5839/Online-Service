...
public class MakeVideoList17 {
	...
	public static void createMyAlbums(){
		...
		createCategoryForWebsite("প্রাণিসম্পদ অধিদপ্তর সকল সেবা", R.drawable.animal, "http://old.dls.gov.bd/e_Livestock/Gobadi_Pashur_rog.php");

		createCategoryForWebsite("আপনার জিজ্ঞাসা", R.drawable.animal, "http://sms.dls.gov.bd/ask-question");

		createCategoryForWebsite(" প্রশ্নের উত্তর", R.drawable.animal, "http://sms.dls.gov.bd/home");
