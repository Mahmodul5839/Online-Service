...
public class WebBrowser4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_browser4);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.mhome:
                        ...
                        Toast.makeText(WebBrowser4.this,"হোম মেনুতে আপনাকে স্বাগতম",Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.mrate:
                        webView.loadUrl("https://eticket.railway.gov.bd/login/en");
                        Toast.makeText(WebBrowser4.this,"লগইন করে রেলওয়ে টিকিট সংগ্রহ করুন",Toast.LENGTH_SHORT).show();

                        return true;
                    case R.id.mshare:
                        webView.loadUrl("https://eticket.railway.gov.bd/register/en");
                        Toast.makeText(WebBrowser4.this,"আপনার এনআইডি কার্ড দিয়ে রেজিস্টেশন করুন",Toast.LENGTH_SHORT).show();

                        return true;


                    case R.id.mmore:
                        webView.loadUrl("https://eticket.railway.gov.bd/verify-ticket/en");
                        Toast.makeText(WebBrowser4.this,"আপনার টিকিট যাচাই করুন",Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.mcontac:
                        ...
                        startActivity(name);
                        Toast.makeText(WebBrowser4.this,"অ্যাপসের মধ্যে যেকোনো সেবা পেতে আমাদের মেসেজ করুন",Toast.LENGTH_LONG).show();
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(WebBrowser4.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(WebBrowser4.this);
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(WebBrowser4.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(WebBrowser4.this)){
