...
public class MakeVideoList14 {
	...
	public static void createMyAlbums(){
		...
		createCategoryForWebsite("হবিগঞ্জ জেলা সকল হসপিটাল", R.drawable.doctorr, "https://drive.google.com/file/d/14_NHpAXGHMpMzevXcmSlc6bwg6pF1O2M/view?usp=sharing");

		createCategoryForWebsite("মৌলভীবাজার জেলা সকল হসপিটাল", R.drawable.doctorr, "https://drive.google.com/file/d/1Up_kaDcrrrMIokQ3uhpm-QGN7UTWWr2t/view?usp=sharing");

		createCategoryForWebsite("সুনামগঞ্জ জেলা সকল হসপিটাল", R.drawable.doctorr, "https://drive.google.com/file/d/19Q-XTNGiIp2j4wK84-FsmHIkM06o_gVy/view?usp=sharing");

		createCategoryForWebsite("সিলেট জেলা সকল হসপিটাল", R.drawable.doctorr, "https://drive.google.com/file/d/1y1yGGpLTPQckkdEaOl1gfFVQTJo7rl83/view?usp=sharing");
