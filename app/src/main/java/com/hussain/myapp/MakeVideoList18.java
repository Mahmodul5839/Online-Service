...
public class MakeVideoList18 {
	...
	public static void createMyAlbums(){
		...
		createCategoryForWebsite("রেলওয়ে ই-টিকিট সেবা ", R.drawable.online_ticket, "https://eticket.railway.gov.bd/");
		createCategoryForPDF("রেলওয়ে চলাচলের সময়সূচি", R.drawable.railway_station, "train_time.pdf");
		createCategoryForPDF("রেলওয়ে চলাচলের সময়সূচি", R.drawable.railway_station, "railway_tikit.pdf");
